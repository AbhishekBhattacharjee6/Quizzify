...
import com.example.quizzify.Fragments.SavedListPractice
import com.example.quizzify.R
import com.example.quizzify.datamodels.QuestionModel
import com.example.quizzify.datamodels.ShuffledOptionsModel

class SavedListPracticeAdapter(val frag:SavedListPractice,var QuestionList:List<String>,var QuestionID:List<String>,var CorrectIndexList:List<Int>,var Options:List<ShuffledOptionsModel>):RecyclerView.Adapter<SavedListPracticeAdapter.MyViewHolder>(){
    ...
    private fun markCorrectOption(holder: MyViewHolder, CorrectOption:Int){
        when(CorrectOption){
            0->{
    ...
    private fun markWrongOption(holder: MyViewHolder, WrongOption:Int){
        when(WrongOption){
            0->{
    ...
    private fun markSelected(holder: MyViewHolder, SelectedOption:Int){
        when(SelectedOption){
            0->{
    ...
    private fun RemoveSelection(holder: MyViewHolder, SelectedOption: Int){
        when(SelectedOption){
            0->{
